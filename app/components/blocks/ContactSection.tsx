          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <a href="https://wa.me/34642029572" target="_blank" rel="noopener noreferrer" className="text-white/90 hover:text-white" aria-label="Contactar por WhatsApp: +34 642 029 572">
                  +34 642 029 572
                </a>
              </div>
              <div className="flex items-start gap-3">
                <PhoneIcon className="w-6 h-6 text-white flex-shrink-0 mt-1" />
                <a href="tel:+34642029572" className="text-white/90 hover:text-white" aria-label="Llamar por teléfono: +34 642 029 572">
                  +34 642 029 572
                </a>
              </div>
            </div>
