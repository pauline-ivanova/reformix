...
export default async function PinturaInteriorPage() {
  ...
  return (
    <>
      <Hero
        title="Servicio de Pintura Interior para tu Reforma en Barcelona y Vallès Occidental"
        titleLines={[
          "Servicio de Pintura Interior",
          "para tu Reforma",
          "en Barcelona y Vallès"
        ]}
        subtitle="El toque final que define la calidad de tu reforma. Acabados perfectos, limpieza garantizada y la tranquilidad de un trabajo bien hecho."
        primaryCTA={{
      ...
      />
      <FeatureGrid
        title="¿Por qué es Importante una Buena Pintura en tu Reforma?"
      ...
      />
      <FeatureGrid
        title="Nuestro Servicio de Pintura: Preparación, Calidad y Limpieza"
      ...
      />
      <FeatureGrid
        title="Más que Pintura: el Toque Final que Marca la Diferencia"
